...
if __name__ == "__main__":
    ...
    scamsRdd2 = scamsRdd.map(lambda x: (x.split(',')[1][1:], 1))
    ...
    my_result_object = my_bucket_resource.Object(s3_bucket,'scams' + date_time + '/partd_scams.txt')
    my_result_object.put(Body=json.dumps(transactionScamsReduced.take(10000)))
